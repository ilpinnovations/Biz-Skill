...
public class LeaderBoardNavBarActivity extends AppCompatActivity {
...
//    LeaderBoardRecycleAdapter leaderBoardRecycleAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new AppCompatDialog(LeaderBoardNavBarActivity.this, R.style.AppCompatProgressDialogStyle);
...
//                        imageurl = c.getString("imageurl");
        ...
        protected void onPostExecute(Void result) {
            ...
            LeaderBoardRecycleAdapter leaderBoardRecycleAdapter = new LeaderBoardRecycleAdapter(LeaderBoardNavBarActivity.this, employeeBeanList);
